...
""",
    ...
    def default_setup(self):
        ...
        #labp cuts
		self.add_param("labplmin", 0.01, cut='l')
		self.add_param("labpamin", 0.01, cut='a')
		self.add_param("labplmax", 1.2, cut='l')
		self.add_param("labangleamin", 0.175, cut='a')
		self.add_param("labangleamax", 999, cut='a')
		self.add_param("labptamin", 0, cut='a')
		self.add_param("labptamax", 4, cut='a')
